...
_magic_number = 9
_modified_time = 1396734004.878462
_enable_loop = True
_template_filename = 'C:\\Users\\Jordan Carlson\\Desktop\\MyStuff\\homepage\\templates/base_dash.htm'
_template_uri = 'base_dash.htm'
_source_encoding = 'ascii'
import os, os.path, re
_exports = ['content', 'main', 'left_side', 'adminOptions', 'title']
