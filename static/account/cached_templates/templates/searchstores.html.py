...
_magic_number = 9
_modified_time = 1391114186.769924
_enable_loop = True
_template_filename = 'C:\\Users\\Jordan Carlson\\Desktop\\MyStuff\\homepage\\templates/searchstores.html'
...
def render_content(context,**pageargs):
    ...
    try:
        ...
        for s in stores:
            # SOURCE LINE 23
            __M_writer('      <tr class="clickableRow" href="/homepage/stores/')
            __M_writer(str(s.id))
            __M_writer('">\n        <td>')
            # SOURCE LINE 24
