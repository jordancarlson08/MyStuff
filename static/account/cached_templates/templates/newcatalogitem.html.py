...
_magic_number = 9
_modified_time = 1390693637.103579
_enable_loop = True
_template_filename = 'D:\\Google Drive\\MyStuff Website\\MyStuff\\homepage\\templates/newcatalogitem.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 1
        __M_writer("<em> ## Mako can find this base file because it's in the settings.py -> MAKO_TEMPLATES_DIRS list\n")
        # SOURCE LINE 2
        __M_writer('\n\n')
        # SOURCE LINE 6
        __M_writer('\n')
