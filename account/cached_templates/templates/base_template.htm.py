...
_magic_number = 9
_modified_time = 1396756539.876789
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_locals_builtin_stored = __M_locals_builtin()
        __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin_stored[__M_key]) for __M_key in ['repair','cart','cart_length','rent','isStaff'] if __M_key in __M_locals_builtin_stored]))
        # SOURCE LINE 66
        __M_writer('\r\n')
        # SOURCE LINE 67
        if cart_length !=0:
