...
_magic_number = 9
_modified_time = 1397181549.030309
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_locals_builtin_stored = __M_locals_builtin()
        __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin_stored[__M_key]) for __M_key in ['manager_check','isManager','employee_check','isEmployee'] if __M_key in __M_locals_builtin_stored]))
        # SOURCE LINE 40
