...
class CheckoutForm(forms.Form):
	...
	ship_first_name = forms.CharField(required=False, label='First Name', max_length=25, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'First Name',}))
	ship_last_name = forms.CharField(required=False, label='Last Name', max_length=25, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Last Name',}))
	ship_phone = forms.CharField(required=False, label='Phone', max_length=25, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': '801-555-1234',}))
	ship_email = forms.CharField(required=False, label='Email', max_length=25, widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'me@example.com',}))
	...
	ship_city = forms.CharField(required=False, label='City', max_length=25, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Provo',}))
