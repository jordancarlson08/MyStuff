...
def render_content(context,**pageargs):
    ...
    try:
        ...
        if item_count == 0 and item.isSerial == True:
            # SOURCE LINE 57
            __M_writer("                            <button id='add_button_disabled' class='btn btn-danger disabled'><span class='glyphicon glyphicon-ban-circle'></span>&nbsp; Out of Stock</button>\r\n")
            # SOURCE LINE 58
        else:
            # SOURCE LINE 59
            __M_writer("                            <button id='add_button' class='btn btn-primary' type='submit'><span class='glyphicon glyphicon-shopping-cart'></span>&nbsp; Add to Cart</button>\r\n")
        # SOURCE LINE 61
